...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic3NoaXZhbXNpbmdoMTIwNiIsImEiOiJja3k4YjlwcGExZHZzMm9wdnN5YW9rZDJiIn0.dOfdHijfe0_YmffEjL4F3A';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/sshivamsingh1206/cky8bgvsq239q14qkjgz58mli',
    // style URL
    scrollZoom: false
  });
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, " ").concat(loc.description, " </p>")).addTo(map); //extend mapbound to set current location
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'error in logout please try again!!');
